  ...
  constructor() {
    super({
      ...
      void main() {
        ...
        // Blue-tinted particles matching the deep navy theme
        vec3 baseColor = vec3(0.376, 0.647, 0.98); // #60a5fa - primary blue
        vec3 accentColor = vec3(0.231, 0.510, 0.965); // #3b82f6 - accent blue
        vec3 particleColor = mix(baseColor, accentColor, sparkleBrightness * 0.3);
